...
export const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      tagline: "Android application for studying flashcards.",
      description:
    ...
    },*/
    {
      title: "2x2 Madness",
      tools: ["JavaScript", "React", "CSS"],
      tagline: "Square grid puzzle about matching colors.",
      description:
    ...
    },
    {
      ...
      tools: ["Java"],
      tagline: "Robot control software for FRC Team 294.",
      description:
    ...
    },
    {
      ...
      tagline: "Explore the town as a raccoon named Skeebo.",
      description:
    ...
    },
    {
      ...
      tagline: "Investigate the secrets of a hilltop mansion.",
      description:
